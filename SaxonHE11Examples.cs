...
namespace SaxonHE11IKVMNet48SaxonCSSamplesAdapted
{

    public class SaxonHE11Examples
    {
        /// <summary>
        /// Run Saxon XSLT and XQuery sample applications with Saxon HE 11 cross-compiled using IKVM for .NET framework 4.8 
        /// </summary>
        /// <param name="argv">
        /// <para>Options:</para>
        /// <list>
    ...
    public class XsltIntegratedExtension : Example
    {
        ...
        public override void run(Uri samplesDir)
        {
            ...
            const string stylesheet = @"<xsl:transform version='3.0' xmlns:xsl='http://www.w3.org/1999/XSL/Transform'" +
                                      ...
                                      @"      exclude-result-prefixes='math env' xmlns='http://example/com/ns1'> " +
                                      @" <xsl:template name='xsl:initial-template'> " +
